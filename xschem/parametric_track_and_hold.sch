...
C {sky130_fd_pr/cap_mim_m3_1.sym} -290 -160 0 1 {name=Cb model=cap_mim_m3_1 W=\{CB\} L=\{CB\} MF=1 spiceprefix=X}
C {devices/lab_pin.sym} -180 -190 3 1 {name=p14 sig_type=std_logic lab=VDD}
C {sky130_fd_pr/cap_mim_m3_1.sym} -290 160 2 0 {name=Cbp model=cap_mim_m3_1 W=\{CB\} L=\{CB\} MF=1 spiceprefix=X}
...
C {devices/lab_pin.sym} -290 -280 0 0 {name=p16 sig_type=std_logic lab=P}
C {devices/lab_pin.sym} -60 -280 1 0 {name=p17 sig_type=std_logic lab=X}
C {devices/lab_pin.sym} -160 -120 0 1 {name=p18 sig_type=std_logic lab=Q}
